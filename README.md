...
* عرض البيانات والتحليلات: مكتبة Dash (واجهة تعمل على `http://127.0.0.1:8050/`)
...
4. لتشغيل واجهة عرض التحليلات، شغّل سكربت Python الخاص بـ Dash وادخل على:
...
يتم حفظ هذه البيانات بصيغة `.csv` لتحليلها لاحقًا باستخدام Python.
...
> يمكن الوصول إلى الواجهة عبر: `http://127.0.0.1:8050/`
>
...
* رفع لوحة التحكم إلى سيرفر سحابي ليتمكن الفريق من مشاهدتها عن بعد.
